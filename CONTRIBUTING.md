...
This repository is a **fork**: upstream [0xPolygonHermez/cdk-erigon](https://github.com/0xPolygonHermez/cdk-erigon)
...
a general-purpose fork of 0xPolygonHermez/cdk-erigon.
...
* Release tags follow `v<base-version>-ct.N` (`ct` = Chaintable; e.g.
  `v2.0.2-merlin-ct.6`); a GitHub Release publishes the versioned images
